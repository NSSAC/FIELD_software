-- queries used to generate :table_name to store county level labor data (only total number)
-- from :source_table
-- parameters:
--
-- table_name:   full table name used to store county level labor data (only total number)
